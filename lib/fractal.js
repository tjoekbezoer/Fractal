...
(function( exports ) {
	...
	View.extend = function( protoProps, staticProps ) {
		...
		if(
			protoProps.defaultState &&
			protoProps.defaultState.constructor == Object
		) {
			protoProps.defaultState = _extend(
				{}, Parent.prototype.defaultState, protoProps.defaultState
			)
		}
	...
	View.prototype = {
		...
		// Indicates whether this view is added to the parent fragment. In <template> supporting
